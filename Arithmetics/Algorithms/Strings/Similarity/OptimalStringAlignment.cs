...
namespace Arithmetics.Arithmetics.Algorithms.Strings.Similarity
{
    /// <summary>
    ...
    public static class OptimalStringAlignment
    {
        ...
        {
            if (string.IsNullOrEmpty(firstString) || string.IsNullOrEmpty(secondString)) { return 0; }

            if (firstString == secondString) { return 0.0; }
